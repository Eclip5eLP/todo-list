...
Please run `npm install -g @angular/cli` globaly and `npm install express mongodb body-parser --save` inside the `/restApi` directory to install the needed dependencies.